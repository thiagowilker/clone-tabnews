  ...
  return (
    <div className="container">
      ...
      <div className="puzzle">
        <Image className="rotate-right" src={blue} height={112} width={112} />
        <Image className="rotate-left" src={green} height={112} width={112} />
      </div>
      <p>
      ...
      <style jsx global>
        {`
          ...
          .rotate-left {
            animation: rotation-left 5s infinite linear;
          }
